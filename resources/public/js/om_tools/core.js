...
if(typeof om_tools.core.t20292 !== 'undefined'){
} else {

/**
* @constructor
*/
om_tools.core.t20292 = (function (get_state,owner,state_proxy,meta20293){
...
om_tools.core.t20292.prototype.cljs$core$ISwap$_swap_BANG_$arity$2 = ((function (get_state){
return (function (s,f){
var self__ = this;
var s__$1 = this;
...
om_tools.core.t20292.prototype.cljs$core$ISwap$_swap_BANG_$arity$3 = ((function (get_state){
...
om_tools.core.t20292.prototype.cljs$core$ISwap$_swap_BANG_$arity$4 = ((function (get_state){
...
om_tools.core.t20292.prototype.cljs$core$ISwap$_swap_BANG_$arity$5 = ((function (get_state){
...
om_tools.core.t20292.prototype.cljs$core$IReset$_reset_BANG_$arity$2 = ((function (get_state){
return (function (_,v){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t20292.prototype.cljs$core$IDeref$_deref$arity$1 = ((function (get_state){
return (function (_){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t20292.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (get_state){
...
om_tools.core.t20292.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (get_state){
return (function (_20294,meta20293__$1){
var self__ = this;
var _20294__$1 = this;
return (new om_tools.core.t20292(self__.get_state,self__.owner,self__.state_proxy,meta20293__$1));
});})(get_state))
;

om_tools.core.t20292.cljs$lang$type = true;

om_tools.core.t20292.cljs$lang$ctorStr = "om-tools.core/t20292";

om_tools.core.t20292.cljs$lang$ctorPrWriter = ((function (get_state){
return (function (this__4538__auto__,writer__4539__auto__,opt__4540__auto__){
return cljs.core._write.call(null,writer__4539__auto__,"om-tools.core/t20292");
});})(get_state))
;

om_tools.core.__GT_t20292 = ((function (get_state){
return (function om_tools$core$state_proxy_$___GT_t20292(get_state__$1,owner__$1,state_proxy__$1,meta20293){
return (new om_tools.core.t20292(get_state__$1,owner__$1,state_proxy__$1,meta20293));
});})(get_state))
;

}

return (new om_tools.core.t20292(get_state,owner,om_tools$core$state_proxy,cljs.core.PersistentArrayMap.EMPTY));
} else {
return null;
}
});
